...
$query_controladores = "SELECT * FROM controladores WHERE id_controlador = '$id_dispositivo'";
...
?>
<!--
<div id="datos_dispositivos" class='box box-widget widget-user'>
<?php
 //   echo ($id_dispositivo);
?>
-->
...
<html>
    ...
    <body style="padding:30px;">
        ...
        <div class="wizard" id="satellite-wizard" data-title="Dispositivo (<?php echo ($nombre);?>)">
...
-->    
                <div class="wizard-success">
                    <div class="alert alert-success">
                        <span class="create-server-name"></span>Dispositivo Modificado <strong>Correctamente.</strong>
                    </div>
    
<!--                    <a class="btn btn-default create-another-server">Create another server</a>-->
<!--                    <span style="padding:0 10px">or</span>-->
                    <a class="btn btn-success im-done">Listo</a>
                </div>
-->                
            </div>
        </div>

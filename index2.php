...
<html>
  <head>
    ...
    <title>My<?php echo ($la_casa);?> | Inicio de Sesi&oacute;n</title>
  ...
  <body class="hold-transition login-page">
    <div class="alert alert-danger alert-dismissable">
        ...
        <span><i class="fa fa-warning"></i><strong> Opps!</strong> Usuario o Contrase&ntilde;a inv&aacute;lidos. </span>
    </div>
